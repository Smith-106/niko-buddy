...
本 Skill 用于整体去AI味，适合一次性处理多种 AI味：解释腔、总结腔、模板句、机械排比、段落过度工整、情绪直白宣布、角色说话像旁白、空泛升华、协作口吻残留、同义反复、无效热闹、空修饰堆叠、单手法循环。处理时先识别 AI味 来源，再进行最小必要改写。去AI味的目标是“降低生成感”，不是“重写成另一篇文章”。先删重复层，再压空修饰，再打散单一手法。
...
- 同义反复 AI味：同一层恨意、同一套气氛词、同一个动作翻来覆去写。
- 无效热闹 AI味：气氛循环、重复心理、重复打趣赶路，热闹不等于进展。
- 空修饰堆叠 AI味：连续空形容词、悬浮大词，没有落到可见动作或后果。
- 单手法循环 AI味：整章只剩对线、独白或打斗一种形式。
...
执行顺序：先删重复层 → 再压空修饰 → 再打散单一手法。只压缩同义反复和无效热闹，不补新剧情。

1. 拒绝无效热闹：气氛循环、重复心理、重复打趣赶路是同一层意思的第二遍。判断废句用三问（不是生成新情节的借口）：这句有没有新信息？关系变了没？矛盾更尖了还是被挪走了？原文没有进展，就压缩重复，不编进展。
2. 具体化，砍空修饰：空泛大词落到可见动作或生理反应；情绪点到为止，后半段同义抒情删；同一对象上连续空形容词只留一个；机械排比三连以上只留最有力的一组；同一喻体不反复，不为限额砍有效意象。
3. 细节三问：先删“他此时非常愤怒”这类标签句。其余细节只要满足其一就留——让读者对角色产生情感偏向、让人设更立体、让后文反转更站得住。三问都空且不是设定/伏笔才删。不要为过三问新编反差动作。
4. 手法不要单轨：整章只剩对线循环、独白绕圈或打斗无信息时，把原文已有的动作、对话、环境、心理、旁观反应穿插成两三种。不为交叉补原文没有的道具或镜头。

## 去AI味处理流程

1. 先删：删除协作口吻、重复解释、空泛总结、无信息量的升华句，以及第二遍气氛、心理、赶路。
2. 再弱化：把强讲解改成弱提示，把空修饰压成具体动作，让读者通过情节、动作、对话和后果自己理解。
3. 再打散：调整过于整齐的句式、段落节奏和单手法循环，但不打乱事件顺序，不补新镜头。
4. 再贴回语境：所有去AI味改写都要回到当前人物、当前场景、当前叙述视角。
5. 最后自检：读一遍结果，确认没有新增剧情、没有换风格、没有把去AI味做成普通润色，信息密度提高了但有效信息还在。
...
- 不新增原文没有的剧情、设定、观点、情绪反转或宏大主题。原文没有进展，就压缩重复，不编进展。
- 不把所有句子都改成短句，也不为了自然感故意制造病句。
- 不主动加入网络口语、古风词、成语堆砌、鸡汤式总结或评论腔。
- 不为了交叉手法补原文没有的道具、旁观者或环境镜头。
...
- 情绪标签 AI味：直接写“他此时非常愤怒/绝望/委屈”，而不是让动作承担。
- 同义反复 AI味：同一层意思换词再说一遍，信息密度被稀释。

## 诊断步骤

1. 标出解释触发词：这说明、这意味着、由此可见、本质上、归根结底、换句话说、显然、事实上、从某种意义上。
2. 判断解释是否必要：如果前文动作、对话、结果已经表达清楚，就删弱或合并。
3. 区分必要因果和多余讲解：必要因果保留，多余心理分析、主题拔高和重复说明删除。同一因果只留最密的一处。
4. 检查段尾：如果段尾只是在替读者总结情绪或意义，优先改成画面、动作、沉默、结果或更克制的判断。
5. 用细节三问判断去留：这段细节能否让读者对角色产生情感偏向、让人设更立体、或让后文反转更站得住？三问都空且不是设定/伏笔，就删。不要为过三问新编反差动作。

## 去AI味处理流程

1. 先删掉无信息解释：凡是只把上一句换种说法的解释，直接删除。先删“他此时非常愤怒”这类替读者贴标签的句子。
2. 对必要因果做压缩：把长解释压成短因果，让逻辑不断但不啰嗦。同一层意思只留最有信息量的一处。
3. 把心理说明交还给行为：能用动作、停顿、视线、语气、选择表达的，不用旁白解释。情绪点到为止，后半段同义抒情删。
4. 把抽象总结落回场景：将“这意味着……”改成更具体的后果、反应或环境变化。
5. 完成后检查去AI味结果：如果读起来像删减版讲义，继续去掉残留的解释腔 AI味。有效信息不能被削成提纲。
...
- 不把解释腔改成更空泛的抒情腔。
- 不新增人物没有表现出来的心理结论，不为过三问新编原文没有的反差动作。
...
- 对线循环：同一句“你诬陷我 / 我没有”来回多轮，场面热闹但没有新信息。
...
- 对线循环 AI味：同一句指控和否认来回多轮，信息不再增加，像在拖字数。
...
3. 再压对线循环：同一句指控和否认来回时，压成一轮有效交锋，不改双方立场，不补原文没有的新证据或新事件。
4. 再调整语气：让句子符合角色身份和当前情绪，不强行现代口语化。
5. 再制造自然缺口：必要时用半句话、停顿、反问、回避、打断替代完整解释。
6. 最后检查 AI味：如果角色仍像在替作者交代信息，继续压缩对白里的说明感。
...
- 不把对话改成段落总结。
- 不为了口语化加入无关语气词。
- 不改变人物关系和剧情信息。对线循环只压缩重复轮次，不改立场，不补新证据。
- 不让所有角色都变成同一种现代口语。
- 不用“嗯、啊、吧、嘛”堆砌来假装自然。
...
- 整章只剩一种形式：连段对线、连段独白、连段打斗，读者已经懂了它还在写。
...
- 单手法循环 AI味：整章只剩对线、独白或打斗一种形式，节奏没有张弛。
...
3. 再破单轨：整章只剩对线循环、独白绕圈或打斗无信息时，把原文已有的动作、对话、环境、心理、旁观反应穿插成两三种。不为交叉补原文没有的道具或镜头。
4. 再删路标：能不用连接词的地方直接删，用具体动作、后果、场景变化承接。
5. 再调长短：短段、中段、厚段按内容需要交替，不为了整齐而均分。
6. 最后检查 AI味：如果文本仍像“观点 + 展开 + 总结”的批量段落，或仍是一种形式撑全章，继续去掉模板感。
...
- 不新增无关细节来填补节奏。不为交叉手法补原文没有的花、杯子、旁观者。
- 不输出结构分析、节奏分析或修改说明。
...
- 同一对象上连续空形容词堆叠，或同一个喻体反复使用，把有效画面稀释了。
...
- 空修饰堆叠 AI味：同一对象上连续空形容词，没有落到可见动作或感官。
- 同一喻体反复 AI味：同一个比喻翻来覆去用，把有效意象稀释成口头禅。
...
2. 再清空泛词：删除或弱化没有具体对象的深沉词、氛围词、宏大词。同一对象上连续空形容词只留最有信息量的一个。
3. 再压升华：把强行上升到人生和命运的句子收回到当前人物、当前场景、当前动作。情绪点到为止，后半段同义抒情删。
4. 再调修辞：保留有效意象，删除重复意象和只负责显得高级的对仗排比。同一个喻体反复出现时，留最准确的一处。不要用单章比喻数量硬顶去砍有效意象。
...
export const BUILT_IN_DE_AI_SKILLS: DeAiSkill[] = [
  {
    ...
    name: "综合去AI味",
    description: "综合减少解释腔、模板句式、机械总结、同义反复和无效热闹。",
  ...
  },
  {
    ...
    name: "减少解释腔",
    description: "重点删掉动机解释、情绪总结、重复说明和过不了三问的废细节。",
  ...
  },
  {
    ...
    name: "对话口语化",
    description: "让人物对话更像真人说话，减少书面腔和对线循环。",
  ...
  },
  {
    ...
    name: "打破工整句式",
    description: "打散整齐段落、排比句、模板化起承转合，以及整章一种形式的单轨推进。",
