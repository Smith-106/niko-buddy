...
const ENTRIES = [
  {
    version: __APP_VERSION__, // vite define from package.json
    date: "2026-09-07",
...
describe("ChangelogSection", () => {
  it("zh 语言：当前版本徽标 + 收起/展开长条目", () => {
    ...
    expect(screen.getByText((_, el) => el?.tagName === "SPAN" && el.textContent === `v${__APP_VERSION__}`)).toBeInTheDocument()
  ...
  it("en 语言渲染英文条目", () => {
    ...
    expect(screen.getByText(`当前版本：v${__APP_VERSION__}`)).toBeInTheDocument()
  })
