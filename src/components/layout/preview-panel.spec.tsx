...
import type { NovelReviewResult, DeAiBatchSummary, DeAiBatchOptions } from "@/lib/novel"
...
vi.mock("@/lib/novel/de-ai-batch", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@/lib/novel/de-ai-batch")>()
  return {
    ...actual,
