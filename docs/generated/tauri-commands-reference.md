...
| `canon_facts_known_by` | canon_commands | ✓ |
| `canon_get_revision` | canon_commands | ✓ |
| `canon_ingest_episode` | canon_commands | ✓ |
| `canon_load_divergence_trace` | canon_commands | ✓ |
| `canon_query` | canon_commands | ✓ |
| `canon_query_batch` | canon_commands | ✓ |
| `canon_query_episodes` | canon_commands | ✓ |
| `canon_save_divergence_trace` | canon_commands | ✓ |
| `canon_supersede_edges` | canon_commands | ✓ |
| `canon_auto_backup` | canon_export | ✓ |
| `canon_export_project` | canon_export | ✓ |
| `canon_restore_project` | canon_export | ✓ |
| `canon_verify_export` | canon_export | ✓ |
