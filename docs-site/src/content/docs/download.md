...
**v2.6.0**（2026-08-22 发布，八项新能力：EPUB/HTML 摄取、指纹去重、图谱精度过滤、chunk compaction、断点 TTL 配置 + 伏笔 abandoned 态、决策回放面板、角色工作台、章节自评估）

前往 [GitHub Releases](https://github.com/Smith-106/niko-buddy/releases) 下载最新 Windows 安装包（macOS/Linux planned）。

### v2.6.0 更新亮点

- ✅ **EPUB/HTML 摄取** — 特化摄取管线 + 提取器注册表，导素材按文档类型自动分派
